    ...
    protected void actionPerformed(GuiButton guibutton) throws IOException {
        ...
        switch (guibutton.id) {
            case START_BUTTON_ID:
                ...
                break;
            case STOP_BUTTON_ID:
                Mekanism.packetHandler.sendToServer(new PacketByteBuf.ByteBufMessage(tileEntity, ByteBufType.GUI_TO_SERVER, 4));
                break;
            ...
            case RESET_BUTTON_ID:
                Mekanism.packetHandler.sendToServer(new PacketByteBuf.ByteBufMessage(tileEntity, ByteBufType.GUI_TO_SERVER, 5));
                break;
            case SILK_TOUCH_BUTTON_ID:
                Mekanism.packetHandler.sendToServer(new PacketByteBuf.ByteBufMessage(tileEntity, ByteBufType.GUI_TO_SERVER, 9));
                break;
