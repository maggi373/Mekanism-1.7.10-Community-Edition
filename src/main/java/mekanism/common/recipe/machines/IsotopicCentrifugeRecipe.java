...
public class IsotopicCentrifugeRecipe extends MachineRecipe<GasInput, GasOutput, IsotopicCentrifugeRecipe> {

    public IsotopicCentrifugeRecipe(GasStack input, GasStack output) {
        super(new GasInput(input), new GasOutput(output));
    }

    public IsotopicCentrifugeRecipe(GasInput input, GasOutput output) {
        super(input, output);
    }

    @Override
    public IsotopicCentrifugeRecipe copy() {
        return new IsotopicCentrifugeRecipe(getInput(), getOutput());
    }
