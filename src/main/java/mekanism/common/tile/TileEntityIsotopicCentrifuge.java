...
public class TileEntityIsotopicCentrifuge extends TileEntityContainerBlock implements IRedstoneControl, IBoundingBlock, IGasHandler, IActiveState, ISustainedData,
    ...
    private IsotopicCentrifugeRecipe cachedRecipe;
    ...
    public void onUpdate() {
        if (!world.isRemote) {
            ...
            IsotopicCentrifugeRecipe recipe = getRecipe();
    ...
    public IsotopicCentrifugeRecipe getRecipe() {
        GasInput input = getInput();
        if (cachedRecipe == null || !input.testEquality(cachedRecipe.getInput())) {
            cachedRecipe = RecipeHandler.getIsotopicCentrifugeRecipeRecipe(getInput());
        }
        return cachedRecipe;
    }
    ...
    public boolean canOperate(IsotopicCentrifugeRecipe recipe) {
        return recipe != null && recipe.canOperate(inputTank, outputTank);
    }

    public void operate(IsotopicCentrifugeRecipe recipe) {
